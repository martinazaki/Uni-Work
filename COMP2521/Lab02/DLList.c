...
void DLListBefore(DLList L, char *it)
{
    ...
    if (L->curr == NULL) {
    ...
    } else if (L->curr->prev == NULL && L->curr->next != NULL) {
        new->next = L->curr;
        new->prev = NULL;
        L->curr->prev = new;
        L->curr = new;
        ...
        DLListNode *prev_node = L->curr->prev;
        new->next = L->curr;
...
void DLListAfter(DLList L, char *it)
{
    ...
    if (curr->next == NULL && curr->prev != NULL) {
        ...
        DLListNode *next_node = L->curr->next;
...
void DLListDelete(DLList L)
{
    ...
    if (L->curr->prev == NULL && L->curr->next != NULL) {
        ...
        next_node->prev = L->curr->prev;
        prev_node->next = L->curr->next;
        L->curr = next_node;
        DLListDelete(temp);
